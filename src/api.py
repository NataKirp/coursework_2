...
class APIAdapter(ABC):
    ...
    @abstractmethod
    def _connect_to_api(
        self, url: str, params: dict[str, Any], headers: Optional[dict[str, str]]
    ) -> requests.Response:
...
class AirplanesAPI(APIAdapter):
    ...
    def __init__(self) -> None:
        ...
        self.airplanes: Optional[dict[str, Any]] = None
    ...
    def get_geo_coordinates(self, country: str) -> Optional[list]:
        ...
        response_nominatim = self._connect_to_api(
    ...
    def filter_airplanes(self, geo_coordinates: list) -> dict:
        ...
        response_opensky = self._connect_to_api(
            self.__opensky_url, params_opensky, None
        )
